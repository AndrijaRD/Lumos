...
private:
    ...
    static string getTextId(const string& title, int fontSize, int weight, SDL_Color color);
    static LoadedText* loadNewText(string title, int fontSize, int weight, SDL_Color color);
