...
void GUI::pushBorderRadius(uint radius) {
  pBorderRadius = BorderRadiusRect(radius);
}
void GUI::pushBorderRadius(BorderRadiusRect radiusRect) {
  pBorderRadius = radiusRect;
}
void GUI::pushBorderRadius(uint topLeft, uint topRight, uint bottomLeft,
                           uint bottomRight) {
  pBorderRadius = {topLeft, topRight, bottomLeft, bottomRight};
}
